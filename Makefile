...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=manager-role crd:generateEmbeddedObjectMeta=true webhook paths="./apis/...;./internal/...;./controllers/dbaas;./controllers/dataprotection;./controllers/k8score;./cmd/manager" output:crd:artifacts:config=config/crd/bases
