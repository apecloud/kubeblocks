...
type Action struct {
	...
	// Specifies whether KubeBlocks should ask kb-agent to execute the Action without
	// waiting for the underlying command or request to complete.
	//
	// When false, an Action call waits for completion and returns the final result.
	...
	// same in-progress or cached terminal result.
	//
	// This field cannot be updated.
	//
	// +kubebuilder:default=false
