...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CredentialAuth) DeepCopyInto(out *CredentialAuth) {
	*out = *in
	if in.Username != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CredentialAuth.
func (in *CredentialAuth) DeepCopy() *CredentialAuth {
	if in == nil {
		return nil
	}
	out := new(CredentialAuth)
	in.DeepCopyInto(out)
	return out
}
