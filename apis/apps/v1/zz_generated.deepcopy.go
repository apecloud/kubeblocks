...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActionCriteria) DeepCopyInto(out *ActionCriteria) {
	*out = *in
	if in.Succeed != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActionCriteria.
func (in *ActionCriteria) DeepCopy() *ActionCriteria {
	if in == nil {
		return nil
	}
	out := new(ActionCriteria)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComponentAvailableCondition) DeepCopyInto(out *ComponentAvailableCondition) {
	*out = *in
	if in.And != nil {
		...
		*out = make([]ComponentAvailableConditionX, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Not != nil {
		...
		*out = new(ComponentAvailableConditionX)
		(*in).DeepCopyInto(*out)
	}
	if in.All != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentAvailableConditionX) DeepCopyInto(out *ComponentAvailableConditionX) {
	*out = *in
	in.ActionCriteria.DeepCopyInto(&out.ActionCriteria)
	in.ComponentAvailableCondition.DeepCopyInto(&out.ComponentAvailableCondition)
	if in.Strict != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentAvailableConditionX.
func (in *ComponentAvailableConditionX) DeepCopy() *ComponentAvailableConditionX {
	if in == nil {
		return nil
	}
	out := new(ComponentAvailableConditionX)
