...
func (in *ShardingLifecycleActions) DeepCopyInto(out *ShardingLifecycleActions) {
	*out = *in
	if in.PostShardProvision != nil {
		in, out := &in.PostShardProvision, &out.PostShardProvision
		*out = new(Action)
		(*in).DeepCopyInto(*out)
	}
	if in.PreShardTerminate != nil {
		in, out := &in.PreShardTerminate, &out.PreShardTerminate
		*out = new(Action)
		(*in).DeepCopyInto(*out)
	}
}
