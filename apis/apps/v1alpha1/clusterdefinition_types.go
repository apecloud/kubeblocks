...
type ClusterDefinitionSpec struct {
	...
	// `${POD_NAME_PREFIX} - the prefix of the pod name in the first component 1ST_COMP`.
	//    where 1ST_COMP is the 1st component that defined in `ClusterDefinition.spec.componentDefs[]` attribute;
