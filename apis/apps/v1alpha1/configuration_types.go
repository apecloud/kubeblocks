...
// TODO(sophon)
// Configuration is an internal API. Configuration is generated by component reconcile(component_configuration_transformer), it is not allowed to modify this cr.
// Configuration operator only updates status.
type ConfigurationSpec struct {
	// Deprecated: renamed to `clusterName`.
