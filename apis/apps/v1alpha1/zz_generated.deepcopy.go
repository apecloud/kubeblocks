...
func (in *ComponentLifecycleActions) DeepCopyInto(out *ComponentLifecycleActions) {
	*out = *in
	...
	if in.ReplicaHealthProbe != nil {
		in, out := &in.ReplicaHealthProbe, &out.ReplicaHealthProbe
		*out = new(v1.Probe)
		(*in).DeepCopyInto(*out)
	}
	if in.ComponentHealthProbe != nil {
		in, out := &in.ComponentHealthProbe, &out.ComponentHealthProbe
		*out = new(v1.Probe)
		(*in).DeepCopyInto(*out)
	}
