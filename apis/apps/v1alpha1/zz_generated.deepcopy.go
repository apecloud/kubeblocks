...
func (in *ClusterComponentSpec) DeepCopyInto(out *ClusterComponentSpec) {
	*out = *in
	...
	if in.ComponentConfigItems != nil {
		in, out := &in.ComponentConfigItems, &out.ComponentConfigItems
		*out = make([]ComponentConfigItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentConfigItem) DeepCopyInto(out *ComponentConfigItem) {
	*out = *in
	...
	if in.ParamsInFile != nil {
		in, out := &in.ParamsInFile, &out.ParamsInFile
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentConfigItem.
func (in *ComponentConfigItem) DeepCopy() *ComponentConfigItem {
	if in == nil {
		return nil
	}
	out := new(ComponentConfigItem)
	in.DeepCopyInto(out)
	return out
}
