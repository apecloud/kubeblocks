...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamedEnvKeyOption) DeepCopyInto(out *NamedEnvKeyOption) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamedEnvKeyOption.
func (in *NamedEnvKeyOption) DeepCopy() *NamedEnvKeyOption {
	if in == nil {
		return nil
	}
	out := new(NamedEnvKeyOption)
	in.DeepCopyInto(out)
	return out
}
