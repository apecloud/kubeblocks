...
func (in *HorizontalScaling) DeepCopyInto(out *HorizontalScaling) {
	*out = *in
	out.ComponentOps = in.ComponentOps
	in.ReplicasWrapper.DeepCopyInto(&out.ReplicasWrapper)
	if in.Instances != nil {
		in, out := &in.Instances, &out.Instances
		*out = new(InstancesOperation)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstancesOperation) DeepCopyInto(out *InstancesOperation) {
	*out = *in
	if in.Add != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstancesOperation.
func (in *InstancesOperation) DeepCopy() *InstancesOperation {
	if in == nil {
		return nil
	}
	out := new(InstancesOperation)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicasWrapper) DeepCopyInto(out *ReplicasWrapper) {
	*out = *in
	if in.Replicas != nil {
		in, out := &in.Replicas, &out.Replicas
		*out = new(int32)
	...
	if in.ReplicasToAdd != nil {
		in, out := &in.ReplicasToAdd, &out.ReplicasToAdd
		*out = new(int32)
		**out = **in
	}
	if in.ReplicasToDelete != nil {
		in, out := &in.ReplicasToDelete, &out.ReplicasToDelete
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicasWrapper.
func (in *ReplicasWrapper) DeepCopy() *ReplicasWrapper {
	if in == nil {
		return nil
	}
	out := new(ReplicasWrapper)
	in.DeepCopyInto(out)
	return out
}
