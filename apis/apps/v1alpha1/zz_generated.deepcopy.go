...
func (in *OpsDefinitionSpec) DeepCopyInto(out *OpsDefinitionSpec) {
	*out = *in
	...
	if in.TargetPodTemplates != nil {
		in, out := &in.TargetPodTemplates, &out.TargetPodTemplates
		*out = make([]TargetPodTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RebuildInstance) DeepCopyInto(out *RebuildInstance) {
	*out = *in
	...
	if in.EnvForRestore != nil {
		in, out := &in.EnvForRestore, &out.EnvForRestore
		*out = make([]v1.EnvVar, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
