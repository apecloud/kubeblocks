...
func (in *HorizontalScaling) DeepCopyInto(out *HorizontalScaling) {
	*out = *in
	...
	if in.OfflineInstance != nil {
		in, out := &in.OfflineInstance, &out.OfflineInstance
		*out = new(OfflineInstance)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OfflineInstance) DeepCopyInto(out *OfflineInstance) {
	*out = *in
	if in.InstanceNames != nil {
		in, out := &in.InstanceNames, &out.InstanceNames
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OfflineInstance.
func (in *OfflineInstance) DeepCopy() *OfflineInstance {
	if in == nil {
		return nil
	}
	out := new(OfflineInstance)
