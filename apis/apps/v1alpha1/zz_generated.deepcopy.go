...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceRefMount) DeepCopyInto(out *ResourceRefMount) {
	*out = *in
	if in.DefaultMode != nil {
		in, out := &in.DefaultMode, &out.DefaultMode
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceRefMount.
func (in *ResourceRefMount) DeepCopy() *ResourceRefMount {
	if in == nil {
		return nil
	}
	out := new(ResourceRefMount)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UserResourceRefs) DeepCopyInto(out *UserResourceRefs) {
	*out = *in
	if in.Secrets != nil {
		...
		*out = make([]ResourceRefMount, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
