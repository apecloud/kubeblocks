...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WaitForClusterPhaseErr) DeepCopyInto(out *WaitForClusterPhaseErr) {
	*out = *in
	if in.expectedPhase != nil {
		in, out := &in.expectedPhase, &out.expectedPhase
		*out = make([]ClusterPhase, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WaitForClusterPhaseErr.
func (in *WaitForClusterPhaseErr) DeepCopy() *WaitForClusterPhaseErr {
	if in == nil {
		return nil
	}
	out := new(WaitForClusterPhaseErr)
	in.DeepCopyInto(out)
	return out
}
