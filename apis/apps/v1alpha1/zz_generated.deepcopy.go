...
func (in *OpsRequestSpec) DeepCopyInto(out *OpsRequestSpec) {
	*out = *in
	...
	if in.RebuildFromBackup != nil {
		in, out := &in.RebuildFromBackup, &out.RebuildFromBackup
		*out = make([]RebuildSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RebuildSpec) DeepCopyInto(out *RebuildSpec) {
	*out = *in
	out.ComponentOps = in.ComponentOps
	out.RestoreSpec = in.RestoreSpec
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RebuildSpec.
func (in *RebuildSpec) DeepCopy() *RebuildSpec {
	if in == nil {
		return nil
	}
	out := new(RebuildSpec)
