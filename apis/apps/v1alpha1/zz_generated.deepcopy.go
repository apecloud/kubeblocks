...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentApp) DeepCopyInto(out *ComponentApp) {
	*out = *in
	if in.AppVersions != nil {
		in, out := &in.AppVersions, &out.AppVersions
		*out = make([]ComponentAppVersion, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentApp.
func (in *ComponentApp) DeepCopy() *ComponentApp {
	if in == nil {
		return nil
	}
	out := new(ComponentApp)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentAppVersion) DeepCopyInto(out *ComponentAppVersion) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentAppVersion.
func (in *ComponentAppVersion) DeepCopy() *ComponentAppVersion {
	if in == nil {
		return nil
	}
	out := new(ComponentAppVersion)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentInstance) DeepCopyInto(out *ComponentInstance) {
	*out = *in
	if in.Apps != nil {
		in, out := &in.Apps, &out.Apps
		*out = make([]ComponentApp, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentInstance.
func (in *ComponentInstance) DeepCopy() *ComponentInstance {
	if in == nil {
		return nil
	}
	out := new(ComponentInstance)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComponentVersionSpec) DeepCopyInto(out *ComponentVersionSpec) {
	*out = *in
	if in.Components != nil {
		in, out := &in.Components, &out.Components
		*out = make([]ComponentInstance, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
