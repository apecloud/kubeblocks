...
func (in *ClusterDefinitionSpec) DeepCopyInto(out *ClusterDefinitionSpec) {
	*out = *in
	...
	if in.ShardingDefs != nil {
		in, out := &in.ShardingDefs, &out.ShardingDefs
...
func (in *ResourceFrom) DeepCopyInto(out *ResourceFrom) {
	*out = *in
	if in.SystemAccountSource != nil {
		in, out := &in.SystemAccountSource, &out.SystemAccountSource
		*out = new(SystemAccountSource)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SystemAccountSource) DeepCopyInto(out *SystemAccountSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SystemAccountSource.
func (in *SystemAccountSource) DeepCopy() *SystemAccountSource {
	if in == nil {
		return nil
	}
	out := new(SystemAccountSource)
