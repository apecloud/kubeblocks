...
func (in *ComponentClassDefinitionStatus) DeepCopyInto(out *ComponentClassDefinitionStatus) {
	*out = *in
	if in.Classes != nil {
		...
		*out = make([]ComponentClassInstance, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ComponentClassInstance) DeepCopyInto(out *ComponentClassInstance) {
	*out = *in
	in.ComponentClass.DeepCopyInto(&out.ComponentClass)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentClassInstance.
func (in *ComponentClassInstance) DeepCopy() *ComponentClassInstance {
	if in == nil {
		return nil
	}
	out := new(ComponentClassInstance)
	in.DeepCopyInto(out)
	return out
}
