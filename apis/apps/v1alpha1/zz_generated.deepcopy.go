...
func (in *ComponentInfo) DeepCopyInto(out *ComponentInfo) {
	*out = *in
	if in.ImageMappings != nil {
		in, out := &in.ImageMappings, &out.ImageMappings
		*out = make([]ImageMappings, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageMappings) DeepCopyInto(out *ImageMappings) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageMappings.
func (in *ImageMappings) DeepCopy() *ImageMappings {
	if in == nil {
		return nil
	}
	out := new(ImageMappings)
	in.DeepCopyInto(out)
	return out
}
