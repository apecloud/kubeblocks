...
func (in *ConfigConstraintSpec) DeepCopyInto(out *ConfigConstraintSpec) {
	*out = *in
	...
	if in.ReloadedPodSelector != nil {
		in, out := &in.ReloadedPodSelector, &out.ReloadedPodSelector
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DownwardAPITriggeredAction) DeepCopyInto(out *DownwardAPITriggeredAction) {
	*out = *in
	if in.Items != nil {
		in, out := &in.Items, &out.Items
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DownwardAPITriggeredAction.
func (in *DownwardAPITriggeredAction) DeepCopy() *DownwardAPITriggeredAction {
	if in == nil {
		return nil
	}
	out := new(DownwardAPITriggeredAction)
	in.DeepCopyInto(out)
	return out
}
