...
type BackupStatus struct {
	...
	// +optional
	Manifests *ManifestsSpec `json:"manifests,omitempty"`
}

type ManifestsSpec struct {
	// BackupLog records startTime and stopTime of data logging
	// +optional
	BackupLog *BackupLogSpec `json:"backupLog,omitempty"`
	...
	// +optional
	Snapshot *BackupSnapshotSpec `json:"backupSnapshot,omitempty"`

	// BackupTool records information about backup files generated by the backup tool.
	// +optional
	BackupTool *BackupToolManifestsSpec `json:"backupTool,omitempty"`
...
type BackupToolManifestsSpec struct {
	// backupToolName referenced backup tool name.
	// +optional
	BackupToolName string `json:"backupToolName,omitempty"`
