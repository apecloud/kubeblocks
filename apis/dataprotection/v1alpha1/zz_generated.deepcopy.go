...
func (in *ActionSetSpec) DeepCopyInto(out *ActionSetSpec) {
	*out = *in
	if in.ParametersSchema != nil {
		...
		*out = new(SelectiveParametersSchema)
		(*in).DeepCopyInto(*out)
	}
	if in.Env != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SelectiveParametersSchema) DeepCopyInto(out *SelectiveParametersSchema) {
	*out = *in
	if in.OpenAPIV3Schema != nil {
		in, out := &in.OpenAPIV3Schema, &out.OpenAPIV3Schema
		*out = (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SelectiveParametersSchema.
func (in *SelectiveParametersSchema) DeepCopy() *SelectiveParametersSchema {
	if in == nil {
		return nil
	}
	out := new(SelectiveParametersSchema)
