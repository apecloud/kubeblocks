...
type Configuration struct {
	...
	// 1. If Scope = ScopeMemory, db engine will make the change specified by reconfigure operator for the life of the instance. The next time the database is bounced, for any reason, the change will be reverted to the latest changed value.
