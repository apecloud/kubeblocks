...
func mergeItsCmpTemplates(itsVcts []appsv1.ClusterComponentVolumeClaimTemplate, cmpVcts []appsv1.ClusterComponentVolumeClaimTemplate) []appsv1.ClusterComponentVolumeClaimTemplate {
	mergedVcts := make([]appsv1.ClusterComponentVolumeClaimTemplate, 0)
