...
func (in *ActionDispatchClaim) DeepCopyInto(out *ActionDispatchClaim) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActionDispatchClaim.
func (in *ActionDispatchClaim) DeepCopy() *ActionDispatchClaim {
	if in == nil {
		return nil
	}
	out := new(ActionDispatchClaim)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProgressStatusDetail) DeepCopyInto(out *ProgressStatusDetail) {
	*out = *in
	...
	if in.DispatchClaim != nil {
		in, out := &in.DispatchClaim, &out.DispatchClaim
		*out = new(ActionDispatchClaim)
		**out = **in
	}
