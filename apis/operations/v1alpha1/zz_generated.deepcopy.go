...
func (in *ActionTask) DeepCopyInto(out *ActionTask) {
	*out = *in
	if in.TaskIndex != nil {
		in, out := &in.TaskIndex, &out.TaskIndex
		*out = new(int32)
		**out = **in
	}
}
...
func (in *CustomOps) DeepCopyInto(out *CustomOps) {
	*out = *in
	if in.ExecutionSnapshot != nil {
		...
		*out = new(CustomOpsExecutionSnapshot)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomOpsExecutionSnapshot) DeepCopyInto(out *CustomOpsExecutionSnapshot) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomOpsExecutionSnapshot.
func (in *CustomOpsExecutionSnapshot) DeepCopy() *CustomOpsExecutionSnapshot {
	if in == nil {
		return nil
	}
	out := new(CustomOpsExecutionSnapshot)
