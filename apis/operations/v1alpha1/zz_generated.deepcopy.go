...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceUpgradeTemplate) DeepCopyInto(out *InstanceUpgradeTemplate) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceUpgradeTemplate.
func (in *InstanceUpgradeTemplate) DeepCopy() *InstanceUpgradeTemplate {
	if in == nil {
		return nil
	}
	out := new(InstanceUpgradeTemplate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UpgradeComponent) DeepCopyInto(out *UpgradeComponent) {
	*out = *in
	...
	if in.Instances != nil {
		in, out := &in.Instances, &out.Instances
		*out = make([]InstanceUpgradeTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
