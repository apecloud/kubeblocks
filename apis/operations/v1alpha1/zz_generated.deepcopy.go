...
func (in *LastComponentConfiguration) DeepCopyInto(out *LastComponentConfiguration) {
	*out = *in
	...
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
		*out = make([]LastParameterAssignment, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LastParameterAssignment) DeepCopyInto(out *LastParameterAssignment) {
	*out = *in
	if in.Value != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LastParameterAssignment.
func (in *LastParameterAssignment) DeepCopy() *LastParameterAssignment {
	if in == nil {
		return nil
	}
	out := new(LastParameterAssignment)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpsRequestStatus) DeepCopyInto(out *OpsRequestStatus) {
	*out = *in
	...
	if in.ReconfigureRollback != nil {
		in, out := &in.ReconfigureRollback, &out.ReconfigureRollback
		*out = new(ReconfigureRollbackStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.Components != nil {
		in, out := &in.Components, &out.Components
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReconfigureRollbackStatus) DeepCopyInto(out *ReconfigureRollbackStatus) {
	*out = *in
	if in.StartTime != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReconfigureRollbackStatus.
func (in *ReconfigureRollbackStatus) DeepCopy() *ReconfigureRollbackStatus {
	if in == nil {
		return nil
	}
	out := new(ReconfigureRollbackStatus)
