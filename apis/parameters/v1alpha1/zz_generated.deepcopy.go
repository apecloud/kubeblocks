...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ParameterValueMap) DeepCopyInto(out *ParameterValueMap) {
	{
		in := &in
		*out = make(ParameterValueMap, len(*in))
		for key, val := range *in {
			var outVal *string
			if val == nil {
				(*out)[key] = nil
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParameterValueMap.
func (in ParameterValueMap) DeepCopy() ParameterValueMap {
	if in == nil {
		return nil
	}
	out := new(ParameterValueMap)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParameterValues) DeepCopyInto(out *ParameterValues) {
	*out = *in
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
		*out = make(ParameterValueMap, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParameterValues.
func (in *ParameterValues) DeepCopy() *ParameterValues {
	if in == nil {
		return nil
	}
	out := new(ParameterValues)
