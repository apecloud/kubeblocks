...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in InitParameters) DeepCopyInto(out *InitParameters) {
	{
		in := &in
		*out = make(InitParameters, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InitParameters.
func (in InitParameters) DeepCopy() InitParameters {
	if in == nil {
		return nil
	}
	out := new(InitParameters)
	in.DeepCopyInto(out)
	return *out
}
