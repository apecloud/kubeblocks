...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InitParameter) DeepCopyInto(out *InitParameter) {
	*out = *in
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
		*out = make(ComponentParameters, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InitParameter.
func (in *InitParameter) DeepCopy() *InitParameter {
	if in == nil {
		return nil
	}
	out := new(InitParameter)
	in.DeepCopyInto(out)
	return out
}
