...
func (in *InstanceSetSpec) DeepCopyInto(out *InstanceSetSpec) {
	*out = *in
	...
	if in.TemplatesOrdinals != nil {
		in, out := &in.TemplatesOrdinals, &out.TemplatesOrdinals
		*out = make([]InstanceTemplateOrdinals, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceTemplateOrdinals) DeepCopyInto(out *InstanceTemplateOrdinals) {
	*out = *in
	in.Ordinals.DeepCopyInto(&out.Ordinals)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceTemplateOrdinals.
func (in *InstanceTemplateOrdinals) DeepCopy() *InstanceTemplateOrdinals {
	if in == nil {
		return nil
	}
	out := new(InstanceTemplateOrdinals)
	in.DeepCopyInto(out)
	return out
}
