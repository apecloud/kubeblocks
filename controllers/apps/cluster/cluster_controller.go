...
// +kubebuilder:rbac:groups=operations.kubeblocks.io,resources=opsdefinitions,verbs=get;list;watch
// +kubebuilder:rbac:groups=operations.kubeblocks.io,resources=opsrequests,verbs=get;list;watch;create
