...
var _ = Describe("resolve CompDefinition and ServiceVersion", func() {
	...
	Context("resolve component definition, service version and images", func() {
		...
		It("full match", func() {
			...
			compDef, resolvedServiceVersion, err := component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1.0"), testapps.ServiceVersion("v1"))
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1.1"), testapps.ServiceVersion("v1"))
			Expect(err).Should(Succeed())
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v2.0"), testapps.ServiceVersion("v1"))
			Expect(err).Should(Succeed())
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1.0"), testapps.ServiceVersion("v2"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.0")))
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1.1"), testapps.ServiceVersion("v2"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.1")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v2.0"), testapps.ServiceVersion("v2"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v3.0"), testapps.ServiceVersion("v3"))
			Expect(err).Should(Succeed())
		...
		It("w/o service version", func() {
			...
			compDef, resolvedServiceVersion, err := component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1.0"), "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1.1"), "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.1")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v2.0"), "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v3.0"), "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v3.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v3")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r5", "r5")
		...
		It("prefix match definition", func() {
			...
			compDef, resolvedServiceVersion, err := component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefinitionName, testapps.ServiceVersion("v1"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v1")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r4", "r4")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefinitionName, testapps.ServiceVersion("v2"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefinitionName, testapps.ServiceVersion("v3"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v3.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v3")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r5", "r5")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1"), testapps.ServiceVersion("v1"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.1")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v1")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r4", "r4")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v2"), testapps.ServiceVersion("v2"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
		...
		It("prefix match definition and w/o service version", func() {
			...
			compDef, resolvedServiceVersion, err := component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefinitionName, "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v3.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v3")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r5", "r5")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1"), "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.1")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v2"), "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
		...
		It("regular expression match definition", func() {
			...
			compDef, resolvedServiceVersion, err := component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefNameWithExactRegex("v2.0"), testapps.ServiceVersion("v1"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v1")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r4", "r4")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefNameWithExactRegex("v2.0"), testapps.ServiceVersion("v2"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefNameWithExactRegex("v3.0"), testapps.ServiceVersion("v3"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v3.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v3")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r5", "r5")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefNameWithFuzzyRegex("v1"), testapps.ServiceVersion("v1"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.1")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v1")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r4", "r4")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefNameWithFuzzyRegex("v2"), testapps.ServiceVersion("v2"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
		...
		It("regular expression match definition and w/o service version", func() {
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefNameWithFuzzyRegex("v1"), "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.1")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
			...
			compDef, resolvedServiceVersion, err = component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefNameWithFuzzyRegex("v2"), "")
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v2.0")))
			Expect(resolvedServiceVersion).Should(Equal(testapps.ServiceVersion("v2")))
			updateNCheckCompDefinitionImages(compDef, resolvedServiceVersion, "r3", "r2")
		...
		It("match from definition", func() {
			By("with definition v1.0 and service version v0")
			compDef, resolvedServiceVersion, err := component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v1.0"), testapps.ServiceVersion("v0"))
			Expect(err).Should(Succeed())
			Expect(compDef.Name).Should(Equal(testapps.CompDefName("v1.0")))
		...
		It("resolve images from definition and version", func() {
			...
			compDef, resolvedServiceVersion, err := component.ResolveCompDefinitionNServiceVersion(testCtx.Ctx, testCtx.Cli, testapps.CompDefName("v4.0"), testapps.ServiceVersion("v4"))
			Expect(err).Should(Succeed())
