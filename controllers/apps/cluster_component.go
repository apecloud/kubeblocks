...
func reconcileComponentWorkloads(reqCtx intctrlutil.RequestCtx,
	...
	if err := cleanUselessServices(reqCtx, cli, cluster); err != nil {
		return false, err
	}
...
func cleanUselessServices(reqCtx intctrlutil.RequestCtx, cli client.Client, cluster *appsv1alpha1.Cluster) error {
	var (
