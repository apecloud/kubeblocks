...
func needSyncClusterStatusOperations(reqCtx intctrlutil.RequestCtx, cli client.Client, cluster *appsv1alpha1.Cluster, storageClass *storagev1.StorageClass) (bool, error) {
...
func clusterContainsStorageClass(cluster *appsv1alpha1.Cluster, storageClassName string) bool {
...
func getSupportVolumeExpansionComponents(ctx context.Context, cli client.Client,
	cluster *appsv1alpha1.Cluster) ([]appsv1alpha1.OperationComponent, error) {
	var (
		...
		volumeExpansionComponents         = make([]appsv1alpha1.OperationComponent, 0)
	)
	for _, v := range cluster.Spec.ComponentSpecs {
		operationComponent := appsv1alpha1.OperationComponent{}
...
func needSyncClusterStatusWhenAllowExpansion(componentName, volumeClaimTemplateName string, cluster *appsv1alpha1.Cluster) bool {
	var (
		needSyncStatusOperations bool
	...
	if needAppendComponent {
		volumeExpandable = append(volumeExpandable, appsv1alpha1.OperationComponent{
			Name:                     componentName,
...
func needSyncClusterStatusWhenNotAllowExpansion(componentName, volumeClaimTemplateName string, cluster *appsv1alpha1.Cluster) bool {
	var (
		needSyncStatusOperations bool
		volumeExpandable         = cluster.Status.Operations.VolumeExpandable
	)
...
func needSyncClusterStatus(storageClass *storagev1.StorageClass,
	...
	cluster *appsv1alpha1.Cluster) bool {
...
func handleNoExistsPVC(reqCtx intctrlutil.RequestCtx, cli client.Client, cluster *appsv1alpha1.Cluster) (bool, error) {
