...
var _ = Describe("ComponentDefinition Controller", func() {
	...
	Context("connection credential", func() {
		...
		It("both service and pod endpoint defined", func() {
			By("create a ComponentDefinition obj")
			...
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				...
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredentialObj(credential).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("service endpoint w/o service name", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(nil).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential("default", "", "", string(appsv1alpha1.AdminAccount)).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("service endpoint no matched service", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(nil).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential("default", "not-exist", "", string(appsv1alpha1.AdminAccount)).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("service endpoint no defined port", func() {
			By("create a ComponentDefinition obj")
		...
		It("service endpoint non-unique port", func() {
			By("create a ComponentDefinition obj")
			serviceSpec := corev1.ServiceSpec{
				Ports: []corev1.ServicePort{
					{Port: 3306},
		...
		It("service endpoint no matched port", func() {
			By("create a ComponentDefinition obj")
			serviceSpec := corev1.ServiceSpec{
				Ports: []corev1.ServicePort{
			...
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{Name: "default", Ports: []corev1.ContainerPort{{Name: "default"}}}).
				AddServiceExt("default", "", serviceSpec, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential("default", "default", "not-exist", string(appsv1alpha1.AdminAccount)).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("pod endpoint non-unique container", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{Name: "default-01"}).
				SetRuntime(&corev1.Container{Name: "default-02"}).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential4Pod("default", "", "", string(appsv1alpha1.AdminAccount)).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("pod endpoint no matched container", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{Name: "default"}).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential4Pod("default", "not-exist", "", string(appsv1alpha1.AdminAccount)).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("pod endpoint no defined port", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{Name: "default"}).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential4Pod("default", "default", "", string(appsv1alpha1.AdminAccount)).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("pod endpoint non-unique port", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{
					Name: "default",
					Ports: []corev1.ContainerPort{
						{Name: "default-01", ContainerPort: 3306},
						{Name: "default-02", ContainerPort: 3310},
					},
				}).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
		...
		It("pod endpoint no matched port", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{Name: "default", Ports: []corev1.ContainerPort{{Name: "default"}}}).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential4Pod("default", "default", "not-exist", string(appsv1alpha1.AdminAccount)).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("pod endpoint ok", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{Name: "default", Ports: []corev1.ContainerPort{{Name: "default"}}}).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential4Pod("default", "default", "default", string(appsv1alpha1.AdminAccount)).
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
		...
		It("w/o system account defined", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{Name: "default", Ports: []corev1.ContainerPort{{Name: "default"}}}).
				AddService("default", "", 3306, "").
		...
		It("no matched system account", func() {
			By("create a ComponentDefinition obj")
			componentDefObj := testapps.NewComponentDefinitionFactory(componentDefName).
				SetRuntime(&corev1.Container{Name: "default", Ports: []corev1.ContainerPort{{Name: "default"}}}).
				AddService("default", "", 3306, "").
				AddSystemAccount(string(appsv1alpha1.AdminAccount), false, "create user").
				AddConnectionCredential("default", "default", "", "not-exist").
				SetLifecycleAction("AccountProvision", defaultActionHandler).
				Create(&testCtx).GetObject()
