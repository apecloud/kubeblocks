...
func NewComponent(reqCtx intctrlutil.RequestCtx,
	...
	case appsv1alpha1.Replication:
		return replication.NewReplicationComponent(cli, reqCtx.Recorder, cluster, version, compDef, synthesizedComp, dag), nil
	case appsv1alpha1.Consensus:
		return consensus.NewConsensusComponent(cli, reqCtx.Recorder, cluster, version, compDef, synthesizedComp, dag), nil
	case appsv1alpha1.Stateful:
		return stateful.NewStatefulComponent(cli, reqCtx.Recorder, cluster, version, compDef, synthesizedComp, dag), nil
	case appsv1alpha1.Stateless:
		return stateless.NewStatelessComponent(cli, reqCtx.Recorder, cluster, version, compDef, synthesizedComp, dag), nil
	}
