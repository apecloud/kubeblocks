...
func injectBuiltInObjects(tplBuilder *configTemplateBuilder, podSpec *corev1.PodSpec, component *component.Component, configs []appsv1alpha1.ConfigTemplate) error {
