...
// componentBackupPolicyTransformer transforms the backup policy template to the data protection backup policy and backup schedule.
...
func (r *componentBackupPolicyTransformer) Transform(ctx graph.TransformContext, dag *graph.DAG) error {
	return nil
}

//// Transform transforms the backup policy template to the backup policy and backup schedule.
//func (r *componentBackupPolicyTransformer) Transform(ctx graph.TransformContext, dag *graph.DAG) error {
//	r.componentTransformContext = ctx.(*componentTransformContext)
//	if model.IsObjectDeleting(r.componentTransformContext.ComponentOrig) {
//		return nil
//	}
//
//	graphCli, _ := r.componentTransformContext.Client.(model.GraphClient)
//
...
//func (r *componentBackupPolicyTransformer) transformBackupPolicy() (*dpv1alpha1.BackupPolicy, *model.Action) {
...
//}
//
//func (r *componentBackupPolicyTransformer) transformBackupSchedule(
...
//}
//
//func (r *componentBackupPolicyTransformer) buildBackupSchedule(
//	name string,
...
//}
//
//func (r *componentBackupPolicyTransformer) syncBackupSchedule(backupSchedule *dpv1alpha1.BackupSchedule) {
...
//func (r *componentBackupPolicyTransformer) syncBackupPolicy(backupPolicy *dpv1alpha1.BackupPolicy) {
...
//}
//
//func (r *componentBackupPolicyTransformer) getCompReplicas() int32 {
...
//func (r *componentBackupPolicyTransformer) buildBackupPolicy(backupPolicyName string) *dpv1alpha1.BackupPolicy {
//	comp := r.getClusterComponentSpec()
//	if comp == nil {
//		return nil
//	}
...
//func (r *componentBackupPolicyTransformer) syncBackupMethods(backupPolicy *dpv1alpha1.BackupPolicy) {
...
//}
//
//func (r *componentBackupPolicyTransformer) doEnvMapping(envMapping []appsv1alpha1.EnvMappingVar) []corev1.EnvVar {
...
//}
//
//func (r *componentBackupPolicyTransformer) buildBackupTarget(
...
//}
//
//func (r *componentBackupPolicyTransformer) mergeClusterBackup(
//	backupPolicy *dpv1alpha1.BackupPolicy,
...
//func (r *componentBackupPolicyTransformer) getClusterComponentSpec() *appsv1alpha1.ClusterComponentSpec {
//	for _, v := range r.componentTransformContext.ComponentSpecs {
...
//}
//
//func (r *componentBackupPolicyTransformer) defaultPolicyAnnotationValue() string {
...
//}
//
//func (r *componentBackupPolicyTransformer) buildAnnotations() map[string]string {
...
//}
//
//func (r *componentBackupPolicyTransformer) buildLabels() map[string]string {
...
//func (r *componentBackupPolicyTransformer) buildTargetPodLabels(comp *appsv1alpha1.ClusterComponentSpec) map[string]string {
