...
func TestGcConfigRevision(t *testing.T) {
	...
	assert.Equal(t, configurationv1alpha1.CInitPhase, revisions[1].Phase)
	assert.Equal(t, configurationv1alpha1.CFinishedPhase, revisions[0].Phase)
...
func TestParseRevision(t *testing.T) {
	...
	tests := []struct {
		...
		want: ConfigurationRevision{
			StrRevision: "120000",
			Revision:    120000,
			Phase:       configurationv1alpha1.CPendingPhase,
...
func TestGetLastRevision(t *testing.T) {
	...
	tests := []struct {
		...
		want: ConfigurationRevision{
			Revision:    2,
			StrRevision: "2",
			Phase:       configurationv1alpha1.CRunningPhase,
			Result: intctrlutil.Result{
				Phase:    configurationv1alpha1.CRunningPhase,
				Revision: "2",
			},
