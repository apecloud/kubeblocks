...
//+kubebuilder:rbac:groups=dbaas.kubeblocks.io,resources=configconstraints,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=dbaas.kubeblocks.io,resources=configconstraints/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=dbaas.kubeblocks.io,resources=configconstraints/finalizers,verbs=update
