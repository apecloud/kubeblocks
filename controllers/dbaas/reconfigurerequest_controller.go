...
//+kubebuilder:rbac:groups=dbaas.infracreate.com,resources=reconfigurerequests,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=dbaas.infracreate.com,resources=reconfigurerequests/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=dbaas.infracreate.com,resources=reconfigurerequests/finalizers,verbs=update
