...
prepare_configuration() {
    set_config_option jobmanager.rpc.address {{ $clusterName }}-{{ $jm_component.name }}
...
if [ "$1" = "help" ]; then
    ...
    set_config_option jobmanager.memory.process.size ${JOB_MANAGER_PROCESS_SIZE}
    ...
    set_config_option taskmanager.memory.process.size ${TASK_MANAGER_PROCESS_SIZE}
    args=("${args[@]:1}")
