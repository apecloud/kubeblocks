...
<td>
<em>(Optional)</em>
<p>The maximum number of pods that can be unavailable during scaling.<br />Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%).<br />Absolute number is calculated from percentage by rounding down. This value is ignored<br />if workloadType is Consensus.</p><br />
</td>
</tr>
<tr>
<td>
...
<em>
<a href="#apps.kubeblocks.io/v1alpha1.ReplicationSpec">
ReplicationSpec
</a>
</em>
</td>
<td>
<em>(Optional)</em>
<p>replicationSpec defines replication related spec if workloadType is Replication, required if workloadType is Replication.</p><br />
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>clientImage define image for the component to connect database or engines.<br />This value override ClusterDefinition.spec.componentDefs.systemAccountSpec.cmdExecutorConfig.image. [EXPERIMENTAL]</p><br />
</td>
</tr>
<tr>
<td>
...
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1alpha1.CmdExecutorConfig">CmdExecutorConfig</a>, <a href="#apps.kubeblocks.io/v1alpha1.SwitchCmdExecutorConfig">SwitchCmdExecutorConfig</a>)
</p>
<div>
</div>
<table>
...
<td>
<em>(Optional)</em>
<p>deletion specifies statement how to delete this account.</p><br />
</td>
</tr>
</tbody>
</table>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ReplicationSpec">ReplicationSpec
</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1alpha1.ClusterComponentDefinition">ClusterComponentDefinition</a>)
</p>
...
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1alpha1.ReplicationSpec">ReplicationSpec</a>)
</p>
<div>
</div>
<table>
