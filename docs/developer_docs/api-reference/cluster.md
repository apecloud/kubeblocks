...
The name is optional when ClusterComponentSpec is used as a template (e.g., in <code>sharding</code>),
...
It is used to generate the names of underlying Components following the pattern <code>$(sharding.name)-$(ShardID)</code>.
...
<p>Note that the name defined in Component template(<code>sharding.template.name</code>) will be disregarded
when generating the Component names of the shards. The <code>sharding.name</code> field takes precedence.</p>
</td>
</tr>
<tr>
<td>
...
<h3 id="apps.kubeblocks.io/v1.ShardingVar">ShardingVar
</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.ShardingVarSelector">ShardingVarSelector</a>)
</p>
<div>
</div>
<table>
...
<td>
<em>(Optional)</em>
<p>Reference to the name of the sharding.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>Reference to the shards of the sharding.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<code>ShardingVar</code><br/>
<em>
<a href="#apps.kubeblocks.io/v1.ShardingVar">
ShardingVar
</a>
</em>
</td>
<td>
<p>
(Members of <code>ShardingVar</code> are embedded into this type.)
</p>
</td>
</tr>
</tbody>
