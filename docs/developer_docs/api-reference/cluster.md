...
<code>configs</code><br/>
<em>
<a href="#apps.kubeblocks.io/v1.ComponentConfigTemplate">
...
<em>
<a href="#apps.kubeblocks.io/v1.ComponentScriptTemplate">
...
<td>
<em>(Optional)</em>
<p>Specifies groups of scripts, each provided via a ConfigMap, to be mounted as volumes into the container.
These scripts can be executed during container startup or via specific actions.</p>
<p>Each script group is encapsulated in a ComponentScriptTemplate that includes:</p>
<ul>
...
<tr>
<td>
<code>metricExporter</code><br/>
<em>
<a href="#apps.kubeblocks.io/v1.MetricExporter">
MetricExporter
</a>
</em>
</td>
...
<code>auth</code><br/>
<em>
<a href="#apps.kubeblocks.io/v1.CredentialAuth">
CredentialAuth
</a>
</em>
</td>
...
<li><code>createAccount</code>: Defines the procedure to create a new account.</li>
<li><code>deleteAccount</code>: Defines the procedure to delete an existed account.</li>
</ul>
...
<td>
<em>(Optional)</em>
<p>Specifies the gPRC request to perform.</p>
<p>This field cannot be updated.</p>
</td>
</tr>
<tr>
...
<em>
<a href="#apps.kubeblocks.io/v1.PreCondition">
PreCondition
</a>
</em>
</td>
...
<td>
<em>(Optional)</em>
<p>Specifies the sequence in which components within a cluster topology are started, stopped, and upgraded.
...
<h3 id="apps.kubeblocks.io/v1.ComponentConfigTemplate">ComponentConfigTemplate
</h3>
<p>
...
<td>
<p>Specifies the name of the config template.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>Specifies the namespace of the referenced template ConfigMap object.
...
<td>
<p>Refers to the volume name of PodTemplate.
The config file produced through the template will be mounted to the corresponding volume.
...
<td>
<em>(Optional)</em>
<p>The operator attempts to set default file permissions as 0444.
...
<td>
<em>(Optional)</em>
<p>Defines the procedure to create a new account.</p>
<p>Use Case:
...
<td>
<em>(Optional)</em>
<p>Defines the procedure to delete an existed account.</p>
<p>Note: This field is immutable once it has been set.</p>
</td>
</tr>
</tbody>
...
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.ComponentStatus">ComponentStatus</a>)
</p>
<div>
<p>ComponentPhase defines the phase of a component.</p>
</div>
<table>
<thead>
<tr>
...
<h3 id="apps.kubeblocks.io/v1.ComponentScriptTemplate">ComponentScriptTemplate
</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.ComponentDefinitionSpec">ComponentDefinitionSpec</a>)
</p>
...
<td>
<p>Specifies the name of the script template.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Refers to the volume name of PodTemplate.
The script file produced through the template will be mounted to the corresponding volume.
Must be a DNS_LABEL name.
The volume name must be defined in podSpec.containers[*].volumeMounts.</p>
</td>
</tr>
...
<td>
<em>(Optional)</em>
<p>The operator attempts to set default file permissions as 0555.
However, certain database engines may require different file permissions.
You can specify the desired file permissions here.</p>
<p>Must be specified as an octal value between 0000 and 0777 (inclusive),
or as a decimal value between 0 and 511 (inclusive).
...
<em>
<a href="#apps.kubeblocks.io/v1.SystemAccountPassword">
SystemAccountPassword
</a>
</em>
</td>
<td>
<p>Specifies the password for the account.
The password can be generated based on certain rules or retrieved from a Secret.</p>
...
<h3 id="apps.kubeblocks.io/v1.CredentialAuth">CredentialAuth
</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.ServiceDescriptorSpec">ServiceDescriptorSpec</a>)
</p>
<div>
<p>CredentialAuth specifies the authentication credentials required for accessing an external service.</p>
</div>
<table>
<thead>
<tr>
...
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.CredentialAuth">CredentialAuth</a>, <a href="#apps.kubeblocks.io/v1.ServiceDescriptorSpec">ServiceDescriptorSpec</a>)
</p>
<div>
...
<div>
<p>GRPCAction describes an Action that triggers gPRC requests.</p>
</div>
<table>
<thead>
<tr>
...
<td>
<p>Specifies the target port for the GRPC server.
...
<td>
<em>(Optional)</em>
<p>Indicates the gRPC service method to be invoked. Defaults to the action name.</p>
</td>
</tr>
</tbody>
</table>
...
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.TLSConfig">TLSConfig</a>)
</p>
<div>
...
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.PasswordGenerationPolicy">PasswordGenerationPolicy</a>)
</p>
<div>
<p>LetterCase defines the available cases to be used in password.</p>
</div>
<table>
<thead>
<tr>
...
<h3 id="apps.kubeblocks.io/v1.MetricExporter">MetricExporter
</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.ComponentDefinitionSpec">ComponentDefinitionSpec</a>)
</p>
...
<h3 id="apps.kubeblocks.io/v1.PasswordGenerationPolicy">PasswordGenerationPolicy
</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.SystemAccountPassword">SystemAccountPassword</a>)
</p>
<div>
<p>PasswordGenerationPolicy helps provide to customize complexity of password generation pattern.</p>
</div>
<table>
<thead>
<tr>
...
<h3 id="apps.kubeblocks.io/v1.PreCondition">PreCondition
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.Action">Action</a>)
</p>
<div>
<p>PreCondition defines the available pre-conditions to execute an action.</p>
</div>
<table>
<thead>
<tr>
...
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.MetricExporter">MetricExporter</a>)
</p>
<div>
...
<td>
<em>(Optional)</em>
<p>ObservedGeneration is the most recent generation observed for this ServiceDescriptor.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>Phase valid values are `<code>,</code>Available<code>, 'Unavailable</code>.</p>
</td>
</tr>
<tr>
<td>
...
<h3 id="apps.kubeblocks.io/v1.SystemAccountPassword">SystemAccountPassword
</h3>
<p>
...
<tr>
<td>
<code>generationPolicy</code><br/>
<em>
<a href="#apps.kubeblocks.io/v1.PasswordGenerationPolicy">
...
<td>
<em>(Optional)</em>
<p>References to a secret from which data will be copied to create the new account.</p>
<p>This field is immutable once set.</p>
</td>
</tr>
</tbody>
...
<td>
<p>Specifies the statement template used to create the account.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>Specifies the statement template used to delete the account.</p>
</td>
</tr>
</tbody>
</table>
...
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em><a href="#apps.kubeblocks.io/v1.ComponentVars">ComponentVars</a>, <a href="#apps.kubeblocks.io/v1.CredentialVars">CredentialVars</a>, <a href="#apps.kubeblocks.io/v1.NamedVar">NamedVar</a>, <a href="#apps.kubeblocks.io/v1.ServiceRefVars">ServiceRefVars</a>, <a href="#apps.kubeblocks.io/v1.ServiceVars">ServiceVars</a>)
</p>
<div>
