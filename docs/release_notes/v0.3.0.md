...
**Highlights**
  ...
  * Support horizontal scaling for ApeCloud MySQL, user can add/remove read-only instances.
  * Add replication lag metrics for ApeCloud MySQL.
  * Add alert rules for ApeCloud MySQL.
  * Support policy-based backups.
