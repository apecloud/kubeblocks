...
- **Improvements:**
  ...
  - Supported custom secret password in Redis v.0.9.x ([#1406](https://github.com/apecloud/kubeblocks-addons/pull/1406)).
  - Supported `storageClassName` values for Redis Sentinel ([#1418](https://github.com/apecloud/kubeblocks-addons/pull/1418)).
- **Fixes:**
  - Fixed FQDN issues when scaling out shards in Redis clusters ([#1283](https://github.com/apecloud/kubeblocks-addons/pull/1283)).
