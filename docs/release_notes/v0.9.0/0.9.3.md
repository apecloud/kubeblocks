...
- **Improvements:**
  - Optimized Redis addons by picking changes from the enterprise version ([#1378](https://github.com/apecloud/kubeblocks-addons/pull/1378)).
