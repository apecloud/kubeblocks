...
<td>
<em>(Optional)</em>
<p>replicationSpec defines replication related spec if workloadType is Replication, required if workloadType is Replication.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>clientImage define image for the component to connect database or engines.
This value override ClusterDefinition.spec.componentDefs.systemAccountSpec.cmdExecutorConfig.image. [EXPERIMENTAL]</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>deletion specifies statement how to delete this account.</p>
</td>
</tr>
</tbody>
</table>
...
if switchStatements is not set，we will try to use the built-in switchStatements for the database engine with built-in support.</p>
</td>
</tr>
</tbody>
</table>
