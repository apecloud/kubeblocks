...
```
  ...
  -h, --help                                    help for mysql
      ...
      --smart-engine-enabled                    Enable SmartEngine or not.
      --storage float                           Storage size, the unit is Gi. Value range [1, 10000]. (default 20)
      --tenancy string                          The tenancy of cluster. Legal values [SharedNode, DedicatedNode]. (default "SharedNode")
      --termination-policy string               The termination policy of cluster. Legal values [DoNotTerminate, Halt, Delete, WipeOut]. (default "Delete")
      --userConfigTemplate.namespace string     customized config template.
      --userConfigTemplate.policy string        customized config template. Legal values [patch, none]. (default "none")
      --userConfigTemplate.templateRef string   customized config template.
