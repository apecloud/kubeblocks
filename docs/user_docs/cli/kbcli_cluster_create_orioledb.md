---
title: kbcli cluster create orioledb
---

Create a orioledb cluster.

```
kbcli cluster create orioledb NAME [flags]
```
...
```
  ...
  kbcli cluster create orioledb --cpu 1 --memory 2 --storage 10
```
