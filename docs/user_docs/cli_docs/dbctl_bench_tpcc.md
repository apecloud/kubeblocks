...
```
  ...
  -D, --db string                      Database name (default "dbctl_test")
...
* [dbctl bench tpcc cleanup](dbctl_bench_tpcc_cleanup.md)	 - Cleanup data for TPCC
* [dbctl bench tpcc prepare](dbctl_bench_tpcc_prepare.md)	 - Prepare data for TPCC
* [dbctl bench tpcc run](dbctl_bench_tpcc_run.md)	 - Run workload
