...
* [Handle an exception and uninstall kbcli and KubeBlocks](./handle-exception-and-uninstall-kbcli-and-kubeblocks.md)
* [Enable add-ons](./enable-addons.md)
* [Install ChatGPT Retrieval Plugin on KubeBlocks](./chatgpt-retrieval-plugin-with-kubeblocks.md)