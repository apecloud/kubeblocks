...
GROUP_VERSIONS="apps:v1alpha1 apps:v1beta1 apps:v1 dataprotection:v1alpha1 extensions:v1alpha1 operations:v1alpha1 workloads:v1alpha1 workloads:v1 configuration:v1alpha1"
