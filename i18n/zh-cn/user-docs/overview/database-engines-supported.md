...
- 以下表格中列出的版本可能不是最新版本，可通过 [KubeBlocks Addon GitHub 仓库](https://github.com/apecloud/kubeblocks-addons) 查看最新版本。
...
| Addons (v0.9.0)     |           已支持的版本           | 变配           | 水平伸缩          | 磁盘扩容 | 停止/启动集群   | 重启集群       | 服务暴露 | 备份恢复 | 日志 | 配置 | 升级 (数据库引擎版本) | 账号管理 | 故障恢复 | Switchover | 监控 |
|:------------------:|:------------------------------:|:-------------:|:----------------:|:-------:|:-------------:|:------------:|:------:|:-------:|:----:|:------:|:---------------:|:------:|:------:|:----------:|:----:|
...
| rabbitmq            | <p>3.13.2</p><p>3.12.14</p><p>3.11.28</p><p>3.10.25</p><p>3.9.29</p><p>3.8.14</p>    | ✔️   | ✔️  | ✔️            | ✔️                | ✔️                | ✔️      | N/A            | N/A  | N/A    | N/A                         |  由 RabbitMQ 管理系统管理     | ✔️      | ✔️        |✔️     |
...
| Addon (v0.9.0)     |                                                                             已支持的版本                                                                             | 变配           | 水平伸缩            | 磁盘扩容 | 停止/启动集群      | 重启集群         | 服务暴露 | 备份恢复 | 日志 | 配置 | 升级 (数据库引擎版本) | 账号管理 | 故障恢复 | Switchover | 监控 |
|:-------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------:|:----------------:|:------------:|:----------------:|:----------------:|:------:|:--------------:|:----:|:------:|:---------------------------:|:-------:|:--------:|:----------:|:-------:|
