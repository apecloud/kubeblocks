...
the helm upgrade action will failed, to resolved this issue, possible actions are disable and re-enable the addon, 
and also noted that storage size can only be expanded by PVC resizing.
`)
