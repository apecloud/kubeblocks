...
type SynthesizedComponent struct {
	...
	ClassDefRef                *v1alpha1.ClassDefRef                  `json:"classDefRef,omitempty"`
	ResourceAllocationPolicies v1alpha1.ResourceAllocationPolicies    `json:"resourceAllocationPolicies,omitempty"`
