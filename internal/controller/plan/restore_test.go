...
//	continuousBackupActionSet     *dpv1alpha1.ActionSet
//	continuousBackupActionSetName string
//)
//
//BeforeEach(func() {
...
//	fullBackupActionSet = testapps.CreateCustomizedObj(&testCtx, "backup/backuptool.yaml", &dpv1alpha1.BackupTool{}, testapps.RandomizedObjName())
//	fullBackupActionSetName = fullBackupActionSet.Name
//
//	By("By creating backup tool: ")
//	backupSelfDefineObj := &dpv1alpha1.ActionSet{}
...
//	})
//	continuousBackupActionSet = testapps.CreateCustomizedObj(&testCtx, "backup/pitr_backuptool.yaml",
//		backupSelfDefineObj, testapps.RandomizedObjName())
//	// set datafile backup relies on logfile
//	Expect(testapps.ChangeObj(&testCtx, continuousBackupActionSet, func(tmpObj *dpv1alpha1.ActionSet) {
//		tmpObj.Spec.Physical.RelyOnLogfile = true
//	})).Should(Succeed())
//	continuousBackupActionSetName = continuousBackupActionSet.Name
//
...
//		AddDatafilePolicy().
//		SetBackupToolName(fullBackupActionSetName).
//		SetSchedule("0 * * * *", true).
//		AddIncrementalPolicy().
//		SetBackupToolName(continuousBackupActionSetName).
//		SetSchedule("0 * * * *", true).
//		Create(&testCtx).GetObject()
//
...
//		BackupToolName:                   fullBackupActionSetName,
...
//		BackupToolName:            continuousBackupActionSetName,
//		Manifests: &dpv1alpha1.ManifestsStatus{
//			BackupLog: &dpv1alpha1.BackupLogStatus{
...
//		Expect(testapps.ChangeObj(&testCtx, continuousBackupActionSet, func(tool *dpv1alpha1.BackupTool) {
...
//	if fullBackupActionSet.Spec.Physical.GetPhysicalRestoreCommand() != nil {
//		backupJobKeys = append(backupJobKeys, baseBackupPhysicalRestore())
//	}
//
//	// do continuous backup physical restore
//	if continuousBackupActionSet.Spec.Physical.GetPhysicalRestoreCommand() != nil {
...
//	if fullBackupActionSet.Spec.Logical.GetLogicalRestoreCommand() != nil {
//		backupJobKeys = append(backupJobKeys, baseBackupLogicalRestore())
//	}
//
//	// do continuous logical restore
//	if continuousBackupActionSet.Spec.Logical.GetLogicalRestoreCommand() != nil {
...
//	Expect(testapps.ChangeObj(&testCtx, fullBackupActionSet, func(tool *dpv1alpha1.BackupTool) {
//		fullBackupActionSet.Spec.Logical.RestoreCommands = fullBackupActionSet.Spec.Physical.GetPhysicalRestoreCommand()
//		fullBackupActionSet.Spec.Physical.RestoreCommands = nil
//	})).Should(Succeed())
//	testPITR()
//})
//	})
