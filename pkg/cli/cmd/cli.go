...
import (
	...
	"github.com/apecloud/kubeblocks/pkg/cli/cmd/addon"
	"github.com/apecloud/kubeblocks/pkg/cli/cmd/alert"
	"github.com/apecloud/kubeblocks/pkg/cli/cmd/auth"
	"github.com/apecloud/kubeblocks/pkg/cli/cmd/backuprepo"
	"github.com/apecloud/kubeblocks/pkg/cli/cmd/bench"
	"github.com/apecloud/kubeblocks/pkg/cli/cmd/builder"
	"github.com/apecloud/kubeblocks/pkg/cli/cmd/class"
	...
	infras "github.com/apecloud/kubeblocks/pkg/cli/cmd/infrastructure"
	...
	"github.com/apecloud/kubeblocks/pkg/cli/cmd/version"
...
func initConfig() {
	...
	// disable binding VolumeProtection operation log in kbcli
	viper.SetDefault(types.CfgKeyVolumeProtectLogDisabled, true)
