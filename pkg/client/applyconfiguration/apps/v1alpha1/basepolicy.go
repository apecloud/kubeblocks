...
type BasePolicyApplyConfiguration struct {
	Target              *TargetInstanceApplyConfiguration      `json:"target,omitempty"`
...
func (b *BasePolicyApplyConfiguration) WithTarget(value *TargetInstanceApplyConfiguration) *BasePolicyApplyConfiguration {
	b.Target = value
	return b
}
