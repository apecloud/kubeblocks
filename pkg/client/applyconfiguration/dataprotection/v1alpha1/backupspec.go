...
type BackupSpecApplyConfiguration struct {
	...
	BackupType       *v1alpha1.BackupType `json:"backupType,omitempty"`
...
func (b *BackupSpecApplyConfiguration) WithBackupType(value v1alpha1.BackupType) *BackupSpecApplyConfiguration {
	b.BackupType = &value
	return b
}
