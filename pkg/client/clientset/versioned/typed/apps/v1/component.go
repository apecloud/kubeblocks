...
func newComponents(c *AppsV1Client, namespace string) *components {
	return &components{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *components) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Component, err error) {
	result = &v1.Component{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ComponentList, err error) {
...
func (c *components) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *components) Create(ctx context.Context, component *v1.Component, opts metav1.CreateOptions) (result *v1.Component, err error) {
	result = &v1.Component{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) Update(ctx context.Context, component *v1.Component, opts metav1.UpdateOptions) (result *v1.Component, err error) {
	result = &v1.Component{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) UpdateStatus(ctx context.Context, component *v1.Component, opts metav1.UpdateOptions) (result *v1.Component, err error) {
	result = &v1.Component{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *components) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *components) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Component, err error) {
	result = &v1.Component{}
