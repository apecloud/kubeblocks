...
type ClusterVersionInterface interface {
	...
	Apply(ctx context.Context, clusterVersion *appsv1alpha1.ClusterVersionApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterVersion, err error)
	ApplyStatus(ctx context.Context, clusterVersion *appsv1alpha1.ClusterVersionApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterVersion, err error)
...
func (c *clusterVersions) Apply(ctx context.Context, clusterVersion *appsv1alpha1.ClusterVersionApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterVersion, err error) {
...
func (c *clusterVersions) ApplyStatus(ctx context.Context, clusterVersion *appsv1alpha1.ClusterVersionApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterVersion, err error) {
	if clusterVersion == nil {
		return nil, fmt.Errorf("clusterVersion provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
