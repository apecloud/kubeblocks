...
func newConfigurations(c *AppsV1alpha1Client, namespace string) *configurations {
...
func (c *configurations) UpdateStatus(ctx context.Context, configuration *v1alpha1.Configuration, opts v1.UpdateOptions) (result *v1alpha1.Configuration, err error) {
	result = &v1alpha1.Configuration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configurations").
