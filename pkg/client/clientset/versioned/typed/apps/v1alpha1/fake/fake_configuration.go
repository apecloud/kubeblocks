...
var configurationsResource = v1alpha1.SchemeGroupVersion.WithResource("configurations")

var configurationsKind = v1alpha1.SchemeGroupVersion.WithKind("Configuration")
