...
type ConfigConstraintInterface interface {
	Create(ctx context.Context, configConstraint *v1beta1.ConfigConstraint, opts v1.CreateOptions) (*v1beta1.ConfigConstraint, error)
	Update(ctx context.Context, configConstraint *v1beta1.ConfigConstraint, opts v1.UpdateOptions) (*v1beta1.ConfigConstraint, error)
	UpdateStatus(ctx context.Context, configConstraint *v1beta1.ConfigConstraint, opts v1.UpdateOptions) (*v1beta1.ConfigConstraint, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ConfigConstraint, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ConfigConstraintList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ConfigConstraint, err error)
...
func newConfigConstraints(c *AppsV1beta1Client) *configConstraints {
...
func (c *configConstraints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ConfigConstraint, err error) {
	result = &v1beta1.ConfigConstraint{}
	err = c.client.Get().
...
func (c *configConstraints) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ConfigConstraintList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ConfigConstraintList{}
	err = c.client.Get().
		Resource("configconstraints").
...
func (c *configConstraints) Create(ctx context.Context, configConstraint *v1beta1.ConfigConstraint, opts v1.CreateOptions) (result *v1beta1.ConfigConstraint, err error) {
	result = &v1beta1.ConfigConstraint{}
	err = c.client.Post().
		Resource("configconstraints").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *configConstraints) Update(ctx context.Context, configConstraint *v1beta1.ConfigConstraint, opts v1.UpdateOptions) (result *v1beta1.ConfigConstraint, err error) {
	result = &v1beta1.ConfigConstraint{}
	err = c.client.Put().
		Resource("configconstraints").
...
func (c *configConstraints) UpdateStatus(ctx context.Context, configConstraint *v1beta1.ConfigConstraint, opts v1.UpdateOptions) (result *v1beta1.ConfigConstraint, err error) {
	result = &v1beta1.ConfigConstraint{}
	err = c.client.Put().
		Resource("configconstraints").
		Name(configConstraint.Name).
...
func (c *configConstraints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ConfigConstraint, err error) {
	result = &v1beta1.ConfigConstraint{}
