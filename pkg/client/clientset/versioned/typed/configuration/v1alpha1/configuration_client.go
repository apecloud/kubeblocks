...
// ConfigurationV1alpha1Client is used to interact with features provided by the configuration.kubeblocks.io group.
type ConfigurationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ConfigurationV1alpha1Client) ComponentParameters(namespace string) ComponentParameterInterface {
	return newComponentParameters(c, namespace)
}

func (c *ConfigurationV1alpha1Client) ParametersDefinitions() ParametersDefinitionInterface {
