...
type BackupInterface interface {
	...
	Apply(ctx context.Context, backup *dataprotectionv1alpha1.BackupApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Backup, err error)
	ApplyStatus(ctx context.Context, backup *dataprotectionv1alpha1.BackupApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Backup, err error)
	BackupExpansion
}
...
func newBackups(c *DataprotectionV1alpha1Client, namespace string) *backups {
	return &backups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *backups) Apply(ctx context.Context, backup *dataprotectionv1alpha1.BackupApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Backup, err error) {
	if backup == nil {
...
func (c *backups) ApplyStatus(ctx context.Context, backup *dataprotectionv1alpha1.BackupApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Backup, err error) {
	if backup == nil {
		return nil, fmt.Errorf("backup provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
