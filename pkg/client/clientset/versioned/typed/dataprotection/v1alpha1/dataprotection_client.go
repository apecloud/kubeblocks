...
func (c *DataprotectionV1alpha1Client) ClusterRestores(namespace string) ClusterRestoreInterface {
	return newClusterRestores(c, namespace)
}
...
// NewForConfigAndClient creates a new DataprotectionV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DataprotectionV1alpha1Client, error) {
	...
	return &DataprotectionV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DataprotectionV1alpha1Client for the given config and
...
func New(c rest.Interface) *DataprotectionV1alpha1Client {
	return &DataprotectionV1alpha1Client{c}
}
...
func (c *DataprotectionV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
