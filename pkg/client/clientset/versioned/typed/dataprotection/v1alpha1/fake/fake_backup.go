...
func (c *FakeBackups) Apply(ctx context.Context, backup *dataprotectionv1alpha1.BackupApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Backup, err error) {
	if backup == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(backupsResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.Backup{})
...
func (c *FakeBackups) ApplyStatus(ctx context.Context, backup *dataprotectionv1alpha1.BackupApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Backup, err error) {
	if backup == nil {
		return nil, fmt.Errorf("backup provided to Apply must not be nil")
	}
	data, err := json.Marshal(backup)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(backupsResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1alpha1.Backup{})
