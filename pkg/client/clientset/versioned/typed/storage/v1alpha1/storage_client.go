...
// StorageV1alpha1Client is used to interact with features provided by the storage.kubeblocks.io group.
type StorageV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StorageV1alpha1Client) StorageProviders() StorageProviderInterface {
