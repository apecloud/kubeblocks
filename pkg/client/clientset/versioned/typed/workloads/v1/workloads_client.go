...
// NewForConfig creates a new WorkloadsV1Client for the given config.
...
// NewForConfigAndClient creates a new WorkloadsV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*WorkloadsV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &WorkloadsV1Client{client}, nil
}

// NewForConfigOrDie creates a new WorkloadsV1Client for the given config and
...
// New creates a new WorkloadsV1Client for the given RESTClient.
func New(c rest.Interface) *WorkloadsV1Client {
	return &WorkloadsV1Client{c}
}
...
func (c *WorkloadsV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
