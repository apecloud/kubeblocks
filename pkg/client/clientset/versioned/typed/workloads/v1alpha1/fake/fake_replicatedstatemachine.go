...
// FakeReplicatedStateMachines implements ReplicatedStateMachineInterface
type FakeReplicatedStateMachines struct {
...
func (c *FakeReplicatedStateMachines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(replicatedstatemachinesResource, c.ns, opts))
