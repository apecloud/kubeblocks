...
func (c *FakeWorkloadsV1alpha1) LifecycleActionExecutions(namespace string) v1alpha1.LifecycleActionExecutionInterface {
	return &FakeLifecycleActionExecutions{c, namespace}
}
