...
type InstanceSetInterface interface {
	Create(ctx context.Context, instanceSet *v1alpha1.InstanceSet, opts v1.CreateOptions) (*v1alpha1.InstanceSet, error)
	Update(ctx context.Context, instanceSet *v1alpha1.InstanceSet, opts v1.UpdateOptions) (*v1alpha1.InstanceSet, error)
	UpdateStatus(ctx context.Context, instanceSet *v1alpha1.InstanceSet, opts v1.UpdateOptions) (*v1alpha1.InstanceSet, error)
...
func (c *instanceSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InstanceSet, err error) {
...
func (c *instanceSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstanceSetList, err error) {
...
func (c *instanceSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *instanceSets) Create(ctx context.Context, instanceSet *v1alpha1.InstanceSet, opts v1.CreateOptions) (result *v1alpha1.InstanceSet, err error) {
	result = &v1alpha1.InstanceSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancesets").
...
func (c *instanceSets) Update(ctx context.Context, instanceSet *v1alpha1.InstanceSet, opts v1.UpdateOptions) (result *v1alpha1.InstanceSet, err error) {
	result = &v1alpha1.InstanceSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancesets").
...
func (c *instanceSets) UpdateStatus(ctx context.Context, instanceSet *v1alpha1.InstanceSet, opts v1.UpdateOptions) (result *v1alpha1.InstanceSet, err error) {
	result = &v1alpha1.InstanceSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancesets").
...
func (c *instanceSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *instanceSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *instanceSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InstanceSet, err error) {
	result = &v1alpha1.InstanceSet{}
