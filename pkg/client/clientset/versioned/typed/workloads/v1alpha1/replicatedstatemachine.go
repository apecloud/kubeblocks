...
// ReplicatedStateMachinesGetter has a method to return a ReplicatedStateMachineInterface.
// A group's client should implement this interface.
type ReplicatedStateMachinesGetter interface {
...
// replicatedStateMachines implements ReplicatedStateMachineInterface
type replicatedStateMachines struct {
	client rest.Interface
	ns     string
}

// newReplicatedStateMachines returns a ReplicatedStateMachines
func newReplicatedStateMachines(c *WorkloadsV1alpha1Client, namespace string) *replicatedStateMachines {
	return &replicatedStateMachines{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
// Watch returns a watch.Interface that watches the requested replicatedStateMachines.
func (c *replicatedStateMachines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *replicatedStateMachines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *replicatedStateMachines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
