...
type WorkloadsV1alpha1Interface interface {
	...
	LifecycleActionExecutionsGetter
}
...
func (c *WorkloadsV1alpha1Client) LifecycleActionExecutions(namespace string) LifecycleActionExecutionInterface {
	return newLifecycleActionExecutions(c, namespace)
}
