	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().Components(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().Components(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1.Component{},
		resyncPeriod,
...
func (f *componentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1.Component{}, f.defaultInformer)
}

func (f *componentInformer) Lister() v1.ComponentLister {
	return v1.NewComponentLister(f.Informer().GetIndexer())
}
