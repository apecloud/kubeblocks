...
type ComponentDefinitionInformer interface {
	...
	Lister() v1.ComponentDefinitionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().ComponentDefinitions().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().ComponentDefinitions().Watch(context.TODO(), options)
			},
		},
...
func (f *componentDefinitionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1.ComponentDefinition{}, f.defaultInformer)
}

func (f *componentDefinitionInformer) Lister() v1.ComponentDefinitionLister {
	return v1.NewComponentDefinitionLister(f.Informer().GetIndexer())
}
