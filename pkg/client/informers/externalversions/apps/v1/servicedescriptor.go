...
type ServiceDescriptorInformer interface {
	...
	Lister() v1.ServiceDescriptorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().ServiceDescriptors(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().ServiceDescriptors(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *serviceDescriptorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1.ServiceDescriptor{}, f.defaultInformer)
}

func (f *serviceDescriptorInformer) Lister() v1.ServiceDescriptorLister {
	return v1.NewServiceDescriptorLister(f.Informer().GetIndexer())
}
