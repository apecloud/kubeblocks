	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1alpha1().ConfigConstraints().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1alpha1().ConfigConstraints().Watch(context.TODO(), options)
			},
		},
...
func (f *configConstraintInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1alpha1.ConfigConstraint{}, f.defaultInformer)
}

func (f *configConstraintInformer) Lister() v1alpha1.ConfigConstraintLister {
	return v1alpha1.NewConfigConstraintLister(f.Informer().GetIndexer())
}
