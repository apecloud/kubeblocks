	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DataprotectionV1alpha1().StorageProviders().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DataprotectionV1alpha1().StorageProviders().Watch(context.TODO(), options)
			},
		},
		&dataprotectionv1alpha1.StorageProvider{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storageProviderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dataprotectionv1alpha1.StorageProvider{}, f.defaultInformer)
}
