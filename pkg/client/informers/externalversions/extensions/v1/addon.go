...
import (
	...
	v1 "github.com/apecloud/kubeblocks/pkg/client/listers/extensions/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExtensionsV1().Addons().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExtensionsV1().Addons().Watch(context.TODO(), options)
			},
		},
		&extensionsv1.Addon{},
		resyncPeriod,
...
func (f *addonInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensionsv1.Addon{}, f.defaultInformer)
}
