	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OperationsV1alpha1().OpsDefinitions().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperationsV1alpha1().OpsDefinitions().Watch(context.TODO(), options)
			},
		},
		&operationsv1alpha1.OpsDefinition{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *opsDefinitionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operationsv1alpha1.OpsDefinition{}, f.defaultInformer)
}
