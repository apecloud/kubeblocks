...
import (
	...
	v1alpha1 "github.com/apecloud/kubeblocks/pkg/client/listers/operations/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OperationsV1alpha1().OpsRequests(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperationsV1alpha1().OpsRequests(namespace).Watch(context.TODO(), options)
			},
		},
		&operationsv1alpha1.OpsRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *opsRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operationsv1alpha1.OpsRequest{}, f.defaultInformer)
}
