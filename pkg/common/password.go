...
func (g *Generator) GenerateWithSeed(length, numDigits, numSymbols int, noUpper bool, seed string) (string, error) {
	if len(seed) == 0 {
...
// GenerateWithSeed is the package shortcut for Generator.GenerateWithSeed.
func GenerateWithSeed(length, numDigits, numSymbols int, noUpper bool, seed string) (string, error) {
	...
	return gen.GenerateWithSeed(length, numDigits, numSymbols, noUpper, seed)
}
