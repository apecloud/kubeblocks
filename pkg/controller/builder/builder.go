...
func getCacheCUETplValue(key string, valueCreator func() (*controllerutil.CUETpl, error)) (*controllerutil.CUETpl, error) {
	vIf, ok := cacheCtx[key]
	if ok {
		return vIf.(*controllerutil.CUETpl), nil
	}
	v, err := valueCreator()
	if err != nil {
		return nil, err
...
func buildFromCUE(tplName string, fillMap map[string]any, lookupKey string, target any) error {
	...
	cueTpl, err := getCacheCUETplValue(tplName, func() (*controllerutil.CUETpl, error) {
		return controllerutil.NewCUETplFromBytes(cueFS.ReadFile(tplName))
	})
	if err != nil {
		return err
	}
...
func processContainersInjection(reqCtx controllerutil.RequestCtx,
	cluster *appsv1alpha1.Cluster,
	component *component2.SynthesizedComponent,
	...
	for _, cc := range []*[]corev1.Container{
		...
		for i := range *cc {
			...
			controllerutil.InjectZeroResourcesLimitsIfEmpty(&(*cc)[i])
		}
	}
	return nil
}

func injectEnvs(cluster *appsv1alpha1.Cluster, component *component2.SynthesizedComponent, envConfigName string, c *corev1.Container) error {
...
func BuildPersistentVolumeClaimLabels(component *component2.SynthesizedComponent, pvc *corev1.PersistentVolumeClaim,
	pvcTplName string) {
...
func BuildSvcListWithCustomAttributes(cluster *appsv1alpha1.Cluster, component *component2.SynthesizedComponent,
...
func BuildSvcList(cluster *appsv1alpha1.Cluster, component *component2.SynthesizedComponent) ([]*corev1.Service, error) {
...
func BuildHeadlessSvc(cluster *appsv1alpha1.Cluster, component *component2.SynthesizedComponent) (*corev1.Service, error) {
...
func BuildSts(reqCtx controllerutil.RequestCtx, cluster *appsv1alpha1.Cluster,
	component *component2.SynthesizedComponent, envConfigName string) (*appsv1.StatefulSet, error) {
...
func BuildRSM(reqCtx controllerutil.RequestCtx, cluster *appsv1alpha1.Cluster,
	component *component2.SynthesizedComponent, envConfigName string) (*workloads.ReplicatedStateMachine, error) {
	vctToPVC := func(vct corev1.PersistentVolumeClaimTemplate) corev1.PersistentVolumeClaim {
		return corev1.PersistentVolumeClaim{
			ObjectMeta: vct.ObjectMeta,
			Spec:       vct.Spec,
...
func fixService(namespace, prefix string, component *component2.SynthesizedComponent, alternativeServices ...corev1.Service) []corev1.Service {
...
func getLeaderName(component *component2.SynthesizedComponent) string {
	if component == nil {
		return ""
	}
...
func buildRoleInfo(component *component2.SynthesizedComponent) ([]workloads.ReplicaRole, *workloads.RoleProbe, *workloads.MembershipReconfiguration, *workloads.MemberUpdateStrategy) {
	var (
...
func BuildConnCredential(clusterDefinition *appsv1alpha1.ClusterDefinition, cluster *appsv1alpha1.Cluster,
	component *component2.SynthesizedComponent) (*corev1.Secret, error) {
...
func BuildPDB(cluster *appsv1alpha1.Cluster, component *component2.SynthesizedComponent) (*policyv1.PodDisruptionBudget, error) {
...
func BuildDeploy(reqCtx controllerutil.RequestCtx, cluster *appsv1alpha1.Cluster, component *component2.SynthesizedComponent, envConfigName string) (*appsv1.Deployment, error) {
...
func BuildEnvConfig(cluster *appsv1alpha1.Cluster, component *component2.SynthesizedComponent) (*corev1.ConfigMap, error) {
...
func BuildConfigMapWithTemplate(cluster *appsv1alpha1.Cluster,
	...
	cueFS, _ := debme.FS(cueTemplates, "cue")
	cueTpl, err := getCacheCUETplValue(tplFile, func() (*controllerutil.CUETpl, error) {
		return controllerutil.NewCUETplFromBytes(cueFS.ReadFile(tplFile))
	})
	if err != nil {
		return nil, err
	}
...
func BuildCfgManagerContainer(sidecarRenderedParam *configmanager.CfgManagerBuildParams, component *component2.SynthesizedComponent) (*corev1.Container, error) {
	...
	controllerutil.InjectZeroResourcesLimitsIfEmpty(&container)
...
func BuildRestoreJob(cluster *appsv1alpha1.Cluster, synthesizedComponent *component2.SynthesizedComponent, name, image string, command []string,
	...
	if len(containers) > 0 {
		...
		controllerutil.InjectZeroResourcesLimitsIfEmpty(&containers[0])
	}
	tolerations, err := component2.BuildTolerations(cluster, cluster.Spec.GetComponentByName(synthesizedComponent.Name))
	if err != nil {
		return nil, err
	}
...
func BuildCfgManagerToolsContainer(sidecarRenderedParam *configmanager.CfgManagerBuildParams, component *component2.SynthesizedComponent, toolsMetas []appsv1alpha1.ToolConfig, toolsMap map[string]configmanager.ConfigSpecMeta) ([]corev1.Container, error) {
...
func setToolsScriptsPath(container *corev1.Container, meta configmanager.ConfigSpecMeta) {
	container.Env = append(container.Env, corev1.EnvVar{
		Name:  configmanager.KBTOOLSScriptsPathEnv,
		Value: filepath.Join(configmanager.KBScriptVolumePath, meta.ConfigSpec.Name),
	})
}
