...
func buildProbeContainers(reqCtx controllerutil.RequestCtx, component *SynthesizedComponent) error {
...
func buildProbeContainer() (*corev1.Container, error) {
	...
	cueTpl, err := controllerutil.NewCUETplFromBytes(cueFS.ReadFile("probe_template.cue"))
	if err != nil {
		return nil, err
	}
