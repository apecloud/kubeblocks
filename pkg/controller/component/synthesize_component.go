...
func mergeUserDefinedVolumes(synthesizedComp *SynthesizedComponent, comp *appsv1.Component) error {
	...
	for _, tpls := range [][]appsv1.ComponentTemplateSpec{synthesizedComp.ConfigTemplates, synthesizedComp.ScriptTemplates} {
...
func GetConfigSpecByName(synthesizedComp *SynthesizedComponent, configSpec string) *appsv1.ComponentTemplateSpec {
