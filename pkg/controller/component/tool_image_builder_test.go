...
//	var clusterComponent *SynthesizedComponent
//
//	BeforeEach(func() {
//		// Add any setup steps that needs to be executed before each test
//		clusterObj, ClusterDefObj, clusterVersionObj, _ = configuration.newAllFieldsClusterObj(nil, nil, false)
//		clusterComponent = configuration.newAllFieldsSynthesizedComponent(ClusterDefObj, clusterVersionObj, clusterObj)
...
//					Namespace:   configuration.testCtx.DefaultNamespace,
