...
func FindAll[T interface{}](dag *graph2.DAG) []graph2.Vertex {
	vertices := make([]graph2.Vertex, 0)
...
func FindRootVertex(dag *graph2.DAG) (*ObjectVertex, error) {
	root := dag.Root()
	if root == nil {
...
func ReadCacheSnapshot(transCtx graph2.TransformContext, root client.Object, ml client.MatchingLabels, kinds ...client.ObjectList) (ObjectSnapshot, error) {
...
func DefaultLess(v1, v2 graph2.Vertex) bool {
