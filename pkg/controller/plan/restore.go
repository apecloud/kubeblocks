...
func DoRestore(ctx context.Context, cli client.Client, cluster *appsv1alpha1.Cluster,
	component *component2.SynthesizedComponent, schema *k8sruntime.Scheme) error {
...
func (p *RestoreManager) doFullBackupRestore(component *component2.SynthesizedComponent,
...
func (p *RestoreManager) doLogfileBackupRestore(component *component2.SynthesizedComponent,
...
func (p *RestoreManager) getDataVCT(synthesizedComponent *component2.SynthesizedComponent) corev1.PersistentVolumeClaimTemplate {
...
func (p *RestoreManager) createDataPVCs(synthesizedComponent *component2.SynthesizedComponent, backup *dpv1alpha1.Backup) error {
	// determines the data volume type
	vct := p.getDataVCT(synthesizedComponent)
	if vct.Name == "" {
		return controllerutil2.NewNotFound("can not found any PersistentVolumeClaim of data type")
	}
...
func (p *RestoreManager) getBackupObjectFromAnnotation(synthesizedComponent *component2.SynthesizedComponent) (*dpv1alpha1.Backup, error) {
...
func (p *RestoreManager) BuildDatafileRestoreJob(synthesizedComponent *component2.SynthesizedComponent, backup *dpv1alpha1.Backup, backupTool *dpv1alpha1.BackupTool) (objs []client.Object, err error) {
...
func (p *RestoreManager) BuildDatafileRestoreJobByPVCS(synthesizedComponent *component2.SynthesizedComponent,
	backup *dpv1alpha1.Backup,
	backupTool *dpv1alpha1.BackupTool,
	pvcNames []string,
	...
	for _, pvcName := range pvcNames {
		...
		affinity := component2.BuildAffinity(p.Cluster, p.Cluster.Spec.GetComponentByName(synthesizedComponent.Name))
		if job.Spec.Template.Spec.Affinity, err = component2.BuildPodAffinity(p.Cluster, affinity, synthesizedComponent); err != nil {
			return nil, err
		}
		if p.Scheme != nil {
...
func (p *RestoreManager) buildPITRPhysicalRestoreJob(synthesizedComponent *component2.SynthesizedComponent,
...
func (p *RestoreManager) buildLogicRestoreJob(synthesizedComponent *component2.SynthesizedComponent,
	backup *dpv1alpha1.Backup,
	...
	for pvcName, pod := range pvcsAndPodsMap {
		...
		podENV = append(podENV, corev1.EnvVar{Name: constant.DPDBHost, Value: controllerutil2.BuildPodHostDNS(&pod)})
...
func (p *RestoreManager) createJobsAndWaiting(objs []client.Object) error {
	...
	for _, job := range objs {
		if done, err := p.checkJobDone(client.ObjectKeyFromObject(job)); err != nil {
			...
			return controllerutil2.NewErrorf(controllerutil2.ErrorTypeNeedWaiting, "waiting restore job %s", job.GetName())
		}
	}
	return nil
}
...
func (p *RestoreManager) cleanupJobs(objs []client.Object) error {
	if p.Cluster.Status.Phase == appsv1alpha1.RunningClusterPhase {
		for _, obj := range objs {
			if err := controllerutil2.BackgroundDeleteObject(p.Client, p.Ctx, obj); err != nil {
				return err
			}
		}
	}
...
func (p *RestoreManager) buildCommonLabels(synthesizedComponent *component2.SynthesizedComponent) map[string]string {
