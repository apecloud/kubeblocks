...
func buildConfigToolsContainer(cfgManagerParams *configmanager.CfgManagerBuildParams, podSpec *corev1.PodSpec, comp *component.SynthesizedComponent) error {
	...
	toolsMap := make(map[string]configmanager.ConfigSpecMeta)
...
func checkAndInstallToolsImageVolume(toolContainers []appsv1alpha1.ToolConfig, buildParams []configmanager.ConfigSpecMeta) []appsv1alpha1.ToolConfig {
...
func buildToolsVolumeMount(cfgManagerParams *configmanager.CfgManagerBuildParams, podSpec *corev1.PodSpec, volumeName string, mountPoint string) {
	if configmanager.FindVolumeMount(cfgManagerParams.Volumes, toolsVolumeName) != nil {
		return
	}
