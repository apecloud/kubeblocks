...
var _ graph2.Transformer = &ObjectStatusTransformer{}

func (t *ObjectStatusTransformer) Transform(ctx graph2.TransformContext, dag *graph2.DAG) error {
	...
	switch {
	case model2.IsObjectUpdating(rsmOrig):
	...
	case model2.IsObjectStatusUpdating(rsmOrig):
