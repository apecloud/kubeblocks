...
const (
	...
	// ReConfigureGenerationKey specifies the reconfigure generation.
...
const (
	...
	// DPTargetComponentServiceVersion is the expected serviceVersion of the restore target Component instance.
