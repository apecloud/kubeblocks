...
const (
	...
	// CfgKeyWorkerAdditionalClusterRoleName is the key of additional cluster role name for binding the service account of the worker
	CfgKeyWorkerAdditionalClusterRoleName = "WORKER_ADDITIONAL_CLUSTER_ROLE_NAME"
