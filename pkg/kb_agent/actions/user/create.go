...
func (s *CreateUser) PreCheck(ctx context.Context, req *actions.ActionRequest) error {
...
func (s *CreateUser) Do(ctx context.Context, req *actions.ActionRequest) (*actions.ActionResponse, error) {
