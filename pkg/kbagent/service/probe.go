...
func (s *probeService) HandleRequest(ctx context.Context, payload []byte) ([]byte, error, context.Context) {
	return nil, errors.Wrapf(proto.ErrNotImplemented, "service %s does not support request handling", s.Kind()), nil
}
