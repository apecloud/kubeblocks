...
func NewExecAction(opsRequest *opsv1alpha1.OpsRequest,
	cluster *appsv1.Cluster,
	opsDef *opsv1alpha1.OpsDefinition,
	customCompOps *opsv1alpha1.CustomOpsComponent,
	comp *appsv1.ClusterComponentSpec,
	progressDetail opsv1alpha1.ProgressStatusDetail) *ExecAction {
	return &ExecAction{
...
func (e *ExecAction) buildExecPodSpec(actionCtx ActionContext,
	...
	return &corev1.PodSpec{
		...
		// tolerate all taints
		Tolerations:      getTolerations(e.Cluster, e.Comp),
