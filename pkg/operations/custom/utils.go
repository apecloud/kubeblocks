...
func buildEnvVars(reqCtx intctrlutil.RequestCtx,
	...
	buildEnvVarByEnvRef := func(envVarRef *opsv1alpha1.EnvVarRef) (*corev1.EnvVar, error) {
...
func buildActionPodName(opsRequest *opsv1alpha1.OpsRequest,
	compName,
	actionName string,
	index,
	retries int) string {
...
func getTargetPodInfoExtractor(opsDef *opsv1alpha1.OpsDefinition, podInfoExtractorName string) *opsv1alpha1.PodInfoExtractor {
...
func getTargetTemplateAndPod(ctx context.Context,
	...
	targetPodName,
	podNamespace string) (*opsv1alpha1.PodInfoExtractor, *corev1.Pod, error) {
	if targetPodName == "" {
		return nil, nil, nil
	}
...
func getTargetPods(
	...
	if podSelector.MultiPodSelectionPolicy == opsv1alpha1.Any {
...
func getTolerations(cluster *appsv1.Cluster, compSpec *appsv1.ClusterComponentSpec) []corev1.Toleration {
	schedulePolicy := scheduling.BuildSchedulingPolicy(cluster, compSpec)
	if schedulePolicy == nil {
		return nil
	}
	return schedulePolicy.Tolerations
}
