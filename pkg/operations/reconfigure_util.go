...
func updateOpsLabelWithReconfigure(obj *opsv1alpha1.OpsRequest, params []core.ParamPairs, orinalData map[string]string, formatter *appsv1beta1.FileFormatConfig) {
...
func fromKeyValuePair(parameters []opsv1alpha1.ParameterPair) map[string]interface{} {
...
func processMergedFailed(resource *OpsResource, isInvalid bool, err error) error {
	...
	failedCondition := opsv1alpha1.NewReconfigureFailedCondition(resource.OpsRequest, err)
...
func hasFileUpdate(config opsv1alpha1.ConfigurationItem) bool {
