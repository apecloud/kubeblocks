...
const (
	Reconfigure_OnlineUpgradeParams_FullMethodName = "/proto.Reconfigure/OnlineUpgradeParams"
)
...
func (c *reconfigureClient) OnlineUpgradeParams(ctx context.Context, in *OnlineUpgradeParamsRequest, opts ...grpc.CallOption) (*OnlineUpgradeParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Reconfigure_OnlineUpgradeParams_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedReconfigureServer must be embedded to have
...
func (UnimplementedReconfigureServer) testEmbeddedByValue()                     {}
...
func RegisterReconfigureServer(s grpc.ServiceRegistrar, srv ReconfigureServer) {
	// If the following call pancis, it indicates UnimplementedReconfigureServer was
...
func _Reconfigure_OnlineUpgradeParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reconfigure_OnlineUpgradeParams_FullMethodName,
	}
