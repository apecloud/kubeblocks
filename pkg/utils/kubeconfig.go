...
- cluster:
  ...
  name: k3d-opencli-playground
contexts:
- context:
    cluster: k3d-opencli-playground
    user: admin@k3d-opencli-playground
  name: k3d-opencli-playground
current-context: k3d-opencli-playground
kind: Config
preferences: {}
users:
- name: admin@k3d-opencli-playground
  user:
