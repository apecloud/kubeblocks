...
var _ = Describe("PostgreSQL Patroni High Availability function", func() {
	const clusterDefName = "test-clusterdef"
	const clusterVersionName = "test-clusterversion"
	const clusterNamePrefix = "test-cluster"

	const patroniConfigTemplatePath = "resources/pg_patroni_config_template.yaml"
	const patroniConfigConstraintPath = "resources/pg_patroni_config_constraint.yaml"
	const patroniRBACPath = "resources/patroni_rbac.yaml"
	...
	cleanEnv := func() {
		...
		testapps.ClearResources(&testCtx, generics.BackupPolicyTemplateSignature, ml)
		testapps.ClearResources(&testCtx, generics.ServiceAccountSignature, ml)
		testapps.ClearResources(&testCtx, generics.ClusterRoleSignature, ml)
		testapps.ClearResources(&testCtx, generics.ClusterRoleBindingSignature, ml)
	}
	...
	newHARequest := func(clusterName string, componentName string,
