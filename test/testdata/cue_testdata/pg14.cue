#PGParameter: {
  ...
  autovacuum_naptime: int & >= 1 & <= 2147483 | *15
  ...
  gin_pending_list_limit?: int & >= 64 & <= 2147483647
  ...
  idle_in_transaction_session_timeout: int & >= 0 & <= 2147483647 | *86400000
  ...
  log_min_duration_statement?: int & >= -1 & <= 2147483647
  ...
  log_rotation_size?: int & >= 0 & <= 2097151
  ...
  maintenance_work_mem?: int & >= 1024 & <= 2147483647
  ...
  max_wal_size: int & >= 128 & <= 201326592 | *2048
  ...
  shared_buffers?: int & >= 16 & <= 1073741823
  ...
  wal_receiver_timeout: int & >= 0 & <= 3600000 | *30000

  // (ms) Sets the maximum time to wait for WAL replication.
  wal_sender_timeout: int & >= 0 & <= 3600000 | *30000

  // (kB) Size of new file to fsync instead of writing WAL.
  wal_skip_threshold?: int & >= 0 & <= 2147483647
